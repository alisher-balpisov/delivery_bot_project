        ...
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=ShopMainKeyboardsButtons.REGISTARATION_CODE,
                    callback_data = "get_registration_code_menu"
                )
            ],
            [
                InlineKeyboardButton(
                    text=ShopMainKeyboardsButtons.SHOPS,
                    callback_data = "show_shops"
                )
            ],
            [
                InlineKeyboardButton(
                    text=ShopMainKeyboardsButtons.COURIERS,
                    callback_data = "show_couriers"
                )
            ],
            [
                InlineKeyboardButton(
                    text=ShopMainKeyboardsButtons.ORDERS,
                    callback_data = "show_orders"
                )
            ],
            [
                InlineKeyboardButton(
                    text=ShopMainKeyboardsButtons.DISPUTES,
