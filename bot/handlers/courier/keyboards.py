        ...
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=CourierMainKeyboardsButtons.START_SHIFT, callback_data="start_shift"
                )
            ],
            [
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text=CourierMainKeyboardsButtons.DISPUTES, callback_data="get_disputes"
                )
            ],
            [
                InlineKeyboardButton(
                    text=CourierMainKeyboardsButtons.EDIT_PROFILE, callback_data="edit_profile_menu"
                )
            ],
        ]
    )
